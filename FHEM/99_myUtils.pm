...
{
my $SELF = shift;
my @readingnames =qw(Timestamp SoC_in_Pct Grid_to_Household_in_W Battery_to_Household_in_W PV_self_consumption_in_W PV_to_Battery_in_W PV_to_Grid_in_W PV_power_provision_with_SE_in_W Household_demand_with_SE_in_W PVpeak_in_W PV_power_provision_without_SE_in_W Neg_Inverter_AC_power_in_W Pos_Inverter_AC_power_in_W Neg_Inverter_DC_power_in_W Pos_Inverter_DC_power_in_W PFCR_as_measured_in_W PFCRpos_scheduled_in_W PFCRneg_scheduled_in_W Traded_power_in_W PGRD_as_measured_in_W PFRR_as_measured_in_W PFRRpos_reserved_in_W PFRRneg_reserved_in_W PFCRpos_overfulfillment_setpoint_in_W PFCRneg_overfulfillment_setpoint_in_W Control_Power_to_Battery_in_W Battery_to_Control_Power_in_W Deadband_recharge_in_W Recharge_by_power_demand_in_W Discharge_by_power_sale_in_W ESS_counter_level_discharge_in_Wh HH_counter_level_discharge_in_Wh HH_counter_level_charge_in_Wh PV_counter_level_discharge_in_Wh ESS_counter_level_charge_in_Wh PV_counter_level_charge_in_Wh PVplusHH_counter_level_discharge_in_Wh PVplusHH_counter_level_charge_in_Wh PBH_counter_level_in_Wh PPB_counter_level_in_Wh PRE_counter_level_in_Wh PDI_counter_level_in_Wh PFCRpos_counter_level_in_Wh PFCRneg_counter_level_in_Wh HHpa_in_Wh PFRRpos_counter_level_in_Wh PFRRneg_counter_level_in_Wh Average_Load_Caterva Power_efficiency_year_in_Prozent Power_efficiency_month_in_Prozent Caterva_ESS_energy_loss_charging_in_Wh Caterva_ESS_energy_loss_discharging_in_Wh Recharge_by_power_demand_PV_in_W Recharge_by_power_demand_GRID_in_W PV_self_consumption_in_Wh BO_BusinessOptimumActive BO_BusinessOptimumGRID_Active BO_ModuleBalancingActive BO_CellBalancingActive BO_ForcedChargingActive);
...
foreach (@readings)
 ...
 my $val1  = ReadingsVal("ESS_Minutenwerte", "30_ESS_counter_level_discharge_in_Wh",0);;1 while $val1 =~ s/^(-?\d+)(\d{3})/$1.$2/;;
 fhem("setreading ESS_Minutenwerte 30_ESS_counter_level_discharge_in_Wh_TD $val1");
 ...
 my $val3  = ReadingsVal("ESS_Minutenwerte", "34_ESS_counter_level_charge_in_Wh",0);;1 while $val3 =~ s/^(-?\d+)(\d{3})/$1.$2/;;
 fhem("setreading ESS_Minutenwerte 34_ESS_counter_level_charge_in_Wh_TD $val3");
 my $val4  = ReadingsVal("ESS_Minutenwerte", "35_PV_counter_level_charge_in_Wh",0);;1 while $val4 =~ s/^(-?\d+)(\d{3})/$1.$2/;;
 fhem("setreading ESS_Minutenwerte 35_PV_counter_level_charge_in_Wh_TD $val4");
 my $val5  = ReadingsVal("ESS_Minutenwerte", "36_PVplusHH_counter_level_discharge_in_Wh",0);;1 while $val5 =~ s/^(-?\d+)(\d{3})/$1.$2/;;
